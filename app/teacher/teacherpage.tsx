...
function StatCards({ myStud }: { myStud: Student[] }) {
  ...
  return (
    <div className="stats" style={{ padding: 'clamp(10px,3vw,20px) clamp(12px,3vw,24px) 12px', gap: 19 }}>
      <div className="stat">
...
function SubNav({ active, setActive }: { active: string; setActive: (v: string) => void }) {
  return (
<div className="stats" style={{ padding: 'clamp(8px,2vw,16px) clamp(12px,3vw,24px) 12px', gap: 19, marginBottom: 8 }}>
     {SUB_TABS.map(t => (
        <button
          key={t.id}
